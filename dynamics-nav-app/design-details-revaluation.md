...
In [!INCLUDE[navnow](includes/navnow_md.md)], the following flexibility is supported regarding revaluation:  
...
With this in mind, it is important to establish conventions as to when an item is considered part of the WIP inventory from a financial point of view. In [!INCLUDE[navnow](includes/navnow_md.md)], the following conventions exist:  

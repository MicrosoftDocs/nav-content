...
4. In the **Electronic Document** field, select **Yes (Through Document Exchange Service)**.  
    ...
    > [!NOTE]  
    >  [!INCLUDE[navnow](includes/navnow_md.md)] automatically detects if the document is an invoice or a credit memo and applies the PEPPOL format accordingly.  

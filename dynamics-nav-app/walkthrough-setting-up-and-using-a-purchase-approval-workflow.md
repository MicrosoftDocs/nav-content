...
-   Setting up approval users (incl. setting up a user in Windows and in [!INCLUDE[navnow](includes/navnow_md.md)]).  
...
To test the approval workflow, Sean first logs into [!INCLUDE[navnow](includes/navnow_md.md)] as Alicia, and then requests approval of a purchase order. Sean then logs in as himself, sees the note on his Role Center, follows the link to the approval request for the purchase order, and approves the request.  

## Setting Up the Sample Data  
You must create a new user on the local computer and in [!INCLUDE[navnow](includes/navnow_md.md)] representing Alicia who you will later select as an approval user. Your own user account will represent Sean.  
...
### To add Alicia as a user in [!INCLUDE[navnow](includes/navnow_md.md)]  
...
Use the new Purchase Order Approval Workflow workflow by first logging into [!INCLUDE[navnow](includes/navnow_md.md)] as Alicia to request approval of a purchase order. Then log in as yourself, view the note on the Role Center, follow the link to the approval request, and then approve the request.  

To log into [!INCLUDE[navnow](includes/navnow_md.md)] as different users, you will use the **Run as different user** function.  

### To log into [!INCLUDE[navnow](includes/navnow_md.md)] as Alicia  

1.  For the [!INCLUDE[navnow](includes/navnow_md.md)] web client, on the browser launch button for the web page, press Shift + Right-Click, and then choose **Run as different user**.  

    For the [!INCLUDE[navnow](includes/navnow_md.md)] Windows client, on the launch button for the program, press Shift + Right-Click, and then choose **Run as different user**.  
...
4.  Close [!INCLUDE[navnow](includes/navnow_md.md)].  

### To approve the purchase order, as Sean  

1.  Open [!INCLUDE[navnow](includes/navnow_md.md)] as you generally do. The program will open with you as the user.  
...
The generic version [!INCLUDE[navnow](includes/navnow_md.md)] includes a number of workflow templates for scenarios that are supported by the application code. Most of these are for approval workflows. For more information, see Workflow Templates.  

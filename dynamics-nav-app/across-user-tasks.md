...
---
# Defining User Tasks
In [!INCLUDE[navnow](includes/navnow_md.md)], you can create tasks to remind you of work to be done. You can create tasks for yourself, but you can also assign tasks to others or be assigned a task by someone else in your organization.  

## Managing User Tasks
The **User Tasks** window shows all tasks, and you can easily create and assign new tasks. When you create a task, you can specify the start date and due date, and you can add a link to the window in [!INCLUDE[navnow](includes/navnow_md.md)] where the user must do the work.  

...
### Terminology  
To align with the financial concepts of purchases and sales, [!INCLUDE[navnow](includes/navnow_md.md)] warehouse documentation refers to the following terms for item flow in the warehouse.  

...
1. Create a purchase order and select the vendor, which the item will be bought from. Do not fill any fields on the lines. For more information, see [How to: Record Purchases](purchasing-how-record-purchases.md).

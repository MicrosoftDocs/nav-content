...
2. On the **Chart of Accounts** page, set up the account and name it **Invoice Rounding** or something similar. [!INCLUDE[navnow](includes/navnow_md.md)] will use the account name as text for invoices that are rounded.  

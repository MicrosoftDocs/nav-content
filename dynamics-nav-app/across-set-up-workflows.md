...
|Set up an SMTP server to enable email communication in and out of [!INCLUDE[navnow](includes/navnow_md.md)]|[How to: Set up Email](madeira-how-setup-email.md)|
...
|Share workflows with other [!INCLUDE[navnow](includes/navnow_md.md)] databases.|[How to: Export and Import Workflows](across-how-to-export-and-import-workflows.md)|  

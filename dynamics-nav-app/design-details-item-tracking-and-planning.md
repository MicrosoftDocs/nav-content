...
[!INCLUDE[navnow](includes/navnow_md.md)] makes two types of item application.  
...
> [!NOTE]  
>  If you are working with returns or credit memos and you have set up the **Exact Cost Reversing Mandatory** field in either the **Purchases & Payables Setup** window or the **Sales & Receivables Setup** window, as appropriate for your situation, then [!INCLUDE[navnow](includes/navnow_md.md)] automatically fills the various application entry fields when you use the **Copy Document** function. If you use the **Get Posted Document Lines to Reverse** function, then the fields are always filled automatically.  
...
[!INCLUDE[navnow](includes/navnow_md.md)] offers a feature for analyzing and correcting item applications. This work is performed in the **Application Worksheet** window.  

...
> [!NOTE]  
>  The generic version of [!INCLUDE[navnow](includes/navnow_md.md)] supports notifications as email and as internal notes.  
...
3.  You set up the general content and layout of notifications, including notifications about overdue workflow responses, by setting up notification templates in the **Notification Templates** window. You can use the default templates provided with [!INCLUDE[navnow](includes/navnow_md.md)].  

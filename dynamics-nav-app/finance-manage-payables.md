...
---
# Managing Payables
[!INCLUDE[navnowlong](includes/navnowlong_md.md)] has what you need to effectively manage accounts payable.  
...
[!INCLUDE[navnow](includes/navnow_md.md)] can suggest various payments to vendors, such as payments that will be due soon, or payments where a discount is available. The payment suggestion can consider an amount that you specify as available funds for payment, and eligibility for payment discounts.

## Issue Checks
[!INCLUDE[navnow](includes/navnow_md.md)] lets you issue checks to vendors manually and electronically. You do both in the **Payment Journals** window, where you can also void checks and view check ledger entries.

---
    ...
    description: This topic describes the design behind item tracking in [!INCLUDE[navnow](includes/navnow_md.md)].
...
The following diagram outlines the design of item tracking functionality in [!INCLUDE[navnow](includes/navnow_md.md)].  

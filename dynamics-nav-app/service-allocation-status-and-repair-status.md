...
When you cancel an allocation for a service item, [!INCLUDE[navnow](includes/navnow_md.md)] updates the allocation status of the corresponding allocation entry from **Active** to **Reallocation Needed**.

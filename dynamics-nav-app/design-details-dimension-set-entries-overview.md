---
    ...
    description: This topic describes how dimension set entries are stored and posted in [!INCLUDE[navnow](includes/navnow_md.md)].
...
This topic describes how dimension set entries are stored and posted in [!INCLUDE[navnow](includes/navnow_md.md)].  

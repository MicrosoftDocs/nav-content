---
    title: How to Set Up The Use Tax and Purchase Tax
    description: Sales tax includes taxes that companies pay for using items. Use tax is a United States sales tax.
...
---
# How to: Set Up Use The Tax and Purchase Tax

---
    title: How to Set Up Unrealized Sales Tax and Sales Payment Discounts (Mexico)
    description: You can use the **General Ledger Setup** window to set up unrealized sales tax. You can also set up maximum correction tax amounts so that you can limit the tax correction amounts.
...
---
# How to: Set Up Unrealized Sales Tax and Sales Payment Discounts (Mexico)

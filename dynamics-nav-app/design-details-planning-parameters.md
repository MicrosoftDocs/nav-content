---
    ...
    description: This topic describes the different planning parameters that you can use in [!INCLUDE[navnow](includes/navnow_md.md)].
...
This topic describes the different planning parameters that you can use in [!INCLUDE[navnow](includes/navnow_md.md)].  

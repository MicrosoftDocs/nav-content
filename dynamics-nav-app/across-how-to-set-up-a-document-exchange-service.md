...
2. Fill the fields as described in the following table.  
    ...
    |**Enabled**|Specify if the service is enabled. **Note:**  As soon as you enable the service, at least two job queue entries are created to process the traffic of electronic documents in and out of [!INCLUDE[navnow](includes/navnow_md.md)]. When you disable the service, the job queue entries are deleted.|  

...
The following procedure describes how to delete archived sales orders of the sales order that have been already deleted. The steps are similar for other archived sales and purchase documents.
